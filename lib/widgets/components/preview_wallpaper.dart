...
class PreviewWallpaper extends StatelessWidget {
  ...
  const PreviewWallpaper({super.key , required this.onPreviewPressed, required bool showPreview, required Null Function() onSetWallpaperPressed, required Null Function() onSavePressed, required String title, required String imagePath, required List<String> tags});
